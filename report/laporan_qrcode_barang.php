...
<head>
    ...
    <title>Laporan QR Code Barang</title>
    <style>
        body {
...
<body>
    ...
    <hr class="line">
    <h3 style="text-align: center;">LAPORAN QR CODE BARANG</h3>
    ...
    <table>
        ...
        <tbody>
            <?php
            $query = "SELECT id_barang, nama_barang, qrcode FROM barang ORDER BY id_barang DESC";
